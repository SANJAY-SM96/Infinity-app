...
export default function Footer({ isHomePage = false }) {
  ...
  const footerBg = isDark 
    ? (isHomePage ? 'bg-gray-900 border-t border-gray-800' : 'bg-gray-900 border-t border-gray-700')
    : (isHomePage ? 'bg-gray-900 border-t border-gray-800' : 'bg-gray-800 border-t border-gray-700');
  
  const hoverColor = isHomePage ? 'hover:text-blue-400' : 'hover:text-primary';
  ...
  return (
    <footer className={`${footerBg} mt-16 sm:mt-20 transition-colors duration-300`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <img 
                ...
                decoding="async"
              />
              <h3 className={`text-lg sm:text-xl font-bold ${isHomePage ? 'text-white' : 'text-primary'}`}>
                INFINITY
              </h3>
            </div>
            ...
            <div className="space-y-2 sm:space-y-3">
              <a 
                ...
                className={`flex items-center gap-2 text-gray-400 ${hoverColor} transition-colors text-xs sm:text-sm break-all`}
              >
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
              <li>
                <Link 
                  to="/products" 
                  className={`text-gray-400 transition-colors ${hoverColor} block`}
          ...
          <div>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`text-gray-400 transition-colors hover:text-blue-400 p-2 rounded-lg hover:bg-white/10`}
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`text-gray-400 transition-colors hover:text-pink-400 p-2 rounded-lg hover:bg-white/10`}
        ...
        {/* Bottom */}
        <div className={`border-t ${isHomePage ? 'border-gray-800' : 'border-gray-700'} pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-gray-400 text-xs sm:text-sm`}>
