    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className={`${cardBg} border rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col`}
        >
          {/* Header */}
          <div className={`sticky top-0 ${cardBg} border-b ${isDark ? 'border-gray-700' : 'border-gray-200'} px-6 py-4 flex items-center justify-between z-10`}>
            <div>
            ...
            >
              <FiX className={`w-6 h-6 ${textMuted}`} />
            </button>
          </div>
          ...
          <div className={`sticky bottom-0 ${cardBg} border-t ${isDark ? 'border-gray-700' : 'border-gray-200'} px-6 py-4 flex items-center justify-between`}>
            <button
              type="button"
              onClick={onClose}
              className={`px-6 py-3 border ${isDark ? 'border-gray-600' : 'border-gray-300'} rounded-xl ${textClass} hover:opacity-80 transition`}
            >
              Cancel
            </button>
            <div className="flex gap-3">
              ...
              {currentStep < totalSteps ? (
                <button
                  type="button"
                  onClick={handleNext}
                  className="px-6 py-3 bg-gradient-to-r from-primary via-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg transition"
                >
                  Next
                </button>
              ) : (
                <button
                  ...
                  disabled={loading}
                  className="px-6 py-3 bg-gradient-to-r from-primary via-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
