  ...
  return (
    <div className={`min-h-screen ${bgClass}`}>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative w-full aspect-video overflow-hidden rounded-xl">
              ...
              <div className="absolute top-4 right-4 z-10 flex gap-2">
                {blog.category && (
                  <span className={`px-4 py-2 rounded-lg text-sm font-semibold backdrop-blur-sm shadow-lg ${
                    isDark 
          ...
          <div className="px-6 sm:px-8 lg:px-12 pt-8 pb-6">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pb-6 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="relative ml-auto">
                ...
                {/* Share Menu Dropdown */}
                {showShareMenu && (
                  <div className={`absolute right-0 mt-2 w-48 rounded-lg shadow-xl z-20 ${
                    ...
                    <div className="py-2">
                      {navigator.share && (
                        <button
                          ...
                          className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-600 transition ${
      ...
      <div className="fixed bottom-6 right-6 z-50 md:hidden">
        ...
        {showShareMenu && (
          <div className={`absolute bottom-16 right-0 w-48 rounded-lg shadow-xl ${
            isDark ? 'bg-gray-700' : 'bg-white'
          } border ${isDark ? 'border-gray-600' : 'border-gray-200'}`}>
            <div className="py-2">
              {navigator.share && (
