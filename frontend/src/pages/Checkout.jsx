...
export default function Checkout() {
  ...
  // Theme-based styling
  const cardBg = isDark 
    ? 'bg-gradient-to-br from-gray-800/90 via-gray-800/80 to-gray-900/90 backdrop-blur-xl border-gray-700/50' 
    : 'bg-gradient-to-br from-white/95 via-white/90 to-gray-50/95 backdrop-blur-xl border-gray-200/80';
