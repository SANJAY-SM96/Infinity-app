...
import PhotoViewer3D from '../components/ui/PhotoViewer3D';
...
export default function StudentDashboard() {
  ...
  // Placeholder images for the 3D showcase
  ...
  return (
    ...
    >
      <SEO
        ...
        description="Manage your custom project requests, track progress, and view completed projects."
      />
      ...
      <div className="mb-8">
        ...
        >
          ...
          <p className={`text-sm sm:text-base ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
            Track your project requests and explore new ideas
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="h-48">
            <StatsCard3D
              ...
              color="warning"
              delay={0.2}
              trend={inProgress > 0 ? 'up' : 'neutral'}
              trendValue={inProgress > 0 ? 'Active' : '-'}
            />
          </div>
          <div className="h-48">
            <StatsCard3D
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <motion.div
            ...
            initial="initial"
            animate="animate"
            className={cn(commonClasses.card(isDark), 'flex-1 bg-gradient-to-r', isDark ? 'from-gray-800/50 to-gray-700/50' : 'from-blue-50/50 to-indigo-50/50')}
          >
            <div className="flex flex-col h-full justify-center items-start p-2">
              <h2 className="text-2xl font-bold mb-4">Need a New Project?</h2>
              <p className={`mb-6 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Submit a request for a custom project tailored to your specific requirements.
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => setShowRequestForm(true)}
                className={cn(commonClasses.buttonPrimary(isDark), 'px-8 py-4 flex items-center gap-3 text-lg')}
              >
          ...
          <motion.div
            ...
            initial="initial"
            animate="animate"
            className={cn(commonClasses.card(isDark), 'flex-1 relative overflow-hidden group cursor-pointer')}
            onClick={() => setShowPhotoViewer(true)}
          >
            <div className="absolute inset-0 bg-gradient-to-br from-purple-600/20 to-blue-600/20 z-0" />
            <div className="relative z-10 flex flex-col h-full justify-center items-center text-center p-4">
              ...
              <h2 className="text-2xl font-bold mb-2">Project Showcase</h2>
              <p className={`mb-4 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Explore our gallery of top-tier projects
              </p>
              <span className="text-primary font-semibold group-hover:underline">View Gallery &rarr;</span>
            </div>
          </motion.div>
        </div>
      </div>
