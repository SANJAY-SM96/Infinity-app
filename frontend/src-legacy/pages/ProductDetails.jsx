              ...
              <div className="flex gap-2 sm:gap-3 overflow-x-auto pb-2 scrollbar-hide">
                {product.images.map((img, idx) => (
                  <motion.img
                    ...
                    className={`w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 object-cover rounded-lg sm:rounded-xl cursor-pointer border-2 transition-all flex-shrink-0 ${selectedImage === idx ? 'border-primary scale-105' : isDark ? 'border-gray-700' : 'border-gray-300'
                      }`}
