...
export default function Contact() {
  ...
  const seoData = useMemo(() => {
    ...
    return {
      title: 'Contact Us | Get in Touch | Infinity Web Technology',
      description: 'Contact Infinity Web Technology for custom project requests, buying IT projects, or any queries. Reach us via WhatsApp, email, or contact form. We serve customers across India with 500+ verified IT projects.',
      keywords: 'contact infinity web technology, IT project support, custom project request, buy IT projects, WhatsApp contact, project inquiry, Infinity Web Technology',
      ...
      structuredData: {
        ...
        '@type': 'ContactPage',
        name: 'Contact Infinity Web Technology - IT Project Marketplace',
        description: 'Get in touch with Infinity Web Technology for custom project requests, buying IT projects, or any queries.',
        url: `${baseUrl}/contact`,
        mainEntity: {
          '@type': 'Organization',
  ...
  return (
    ...
    >
      {/* Visible H1 for SEO and page header */}
      <header className="mb-6">
        <h1 className={cn('text-3xl sm:text-4xl md:text-5xl font-extrabold mb-2', commonClasses.textBody(isDark))}>
          Contact Infinity — Get Help, Request Custom Projects, or Publish Requests
        </h1>
        <p className={cn('text-sm sm:text-base md:text-lg', commonClasses.textMuted(isDark))}>
          Use the form below to reach our team for support, custom requests, or general enquiries.
        </p>
      </header>

      {/* Particle effect removed per request */}

      <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 items-start">
        {/* Contact Info Cards */}
        <div className="lg:col-span-1 space-y-4 sm:space-y-6 self-start">
        ...
        <div className="lg:col-span-2 self-stretch">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6">
            <motion.button
              ...
              className={`px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeForm === 'general'
            ...
            <motion.button
              ...
              className={`px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeForm === 'custom-project'
                ? 'bg-gradient-to-r from-primary to-blue-600 text-white'
                : isDark
                  ? 'bg-gray-800 border border-gray-700 text-gray-300'
                  : 'bg-white border border-gray-300 text-gray-700'
            ...
            <motion.button
              ...
              className={`px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold transition whitespace-nowrap ${activeForm === 'buy-project'
                ? 'bg-gradient-to-r from-primary to-blue-600 text-white'
                : isDark
                  ? 'bg-gray-800 border border-gray-700 text-gray-300'
                  : 'bg-white border border-gray-300 text-gray-700'
