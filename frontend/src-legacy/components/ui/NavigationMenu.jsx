  ...
  return (
    ...
    >
      {items.map((item) => {
        ...
        const itemClasses = `${itemBaseClasses} ${itemClassName} ${
          ...
          return (
            <div key={item.id} className="relative nav-dropdown">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold text-sm transition-colors duration-200 flex items-center gap-2 ${
                  isDark
                    ? 'text-white/80 hover:text-white hover:bg-white/10'
                    : 'text-slate-700 hover:text-primary hover:bg-primary/10'
                }`}
