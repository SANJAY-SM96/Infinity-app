        ...
        >
            <div className="flex flex-col items-center gap-6">
                <div className="relative">
                    {/* Ripple effects - Green/Teal for welcome/success */}
                    <motion.div
                    ...
                    <motion.div
                        ...
                        className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-xl shadow-emerald-500/20"
                    >
